...
function MobileNav({ Signin, SignUp }) {
    ...
    const reduxState=useSelector((globalState)=> globalState.userReducer.user.user )
    return (
        ...
        <>
            <div className='hidden lg:inline container px-20 mx-auto '>
                <div className='gap-4 lg:flex w-full items-center justify-around'>
                    ...
                    <div className='w-3/4 bg-white p-3 flex items-center gap-3 border border-gray-200 shadow-md rounded'>

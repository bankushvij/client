...
function CheckoutPage() {
  ...
  const reduxStateCart=useSelector((globalState)=>globalState.cartReducer.cart)
  const reduxStateUser=useSelector((globalState)=>globalState.userReducer.user.user)
  const payNow=()=>
  {
    let options={
